...
public class AdminController {
	...
	public ResponseEntity<Page<ServiceProvider>> getAllProviders(@RequestParam(defaultValue = "0") int page,
		...
		if (search.isEmpty()) {
			...
			results = providerRepo.findByCityContainingIgnoreCaseOrProfessionContainingIgnoreCase(search, search,
					pageable);
		}
